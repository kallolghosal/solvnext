                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <Row>
                                ...
                                <Col style={{ textAlign: 'center', color:'#00ac8d' }}>
                                    <Image src='/img/Health-1.png' alt='Health' width={140} height={140} />
                                    <p style={{ paddingLeft: '40px', paddingRight: '40px', marginTop: '20px' }}>
                                        Strengthening Health and Community Systems | Health
                                    </p>
                                </Col>
                                <Col style={{ textAlign: 'center', color:'#00ac8d' }}>
                                    <Image src='/img/Health-2.png' alt='Health' width={140} height={140} />
                                    <p style={{ paddingLeft: '40px', paddingRight: '40px', marginTop: '20px' }}>
                                        Making worker wellbeing a reality | Wellbeing for Workforce
                                    </p>
                                </Col>
                                <Col style={{ textAlign: 'center', color:'#00ac8d' }}>
                                    <Image src='/img/Livehood.png' alt='Health' width={140} height={140} />
                                    <p style={{ paddingLeft: '40px', paddingRight: '40px', marginTop: '20px' }}>
                                        Supporting enterprises with evidence based solutions | Livelihood
                                    </p>
                                </Col>
                                <Col style={{ textAlign: 'center', color:'#00ac8d' }}>
                                    <Image src='/img/Climate-Icon.png' alt='Health' width={140} height={140} />
                                    <p style={{ paddingLeft: '40px', paddingRight: '40px', marginTop: '20px' }}>
                        ...
                        <div class="carousel-item">
                            <Row>
                                ...
                                <Col style={{ textAlign: 'center', color:'#00ac8d' }}>
                                    <Image src='/img/shape5.png' alt='Health' width={140} height={140} />
                                    <p style={{ paddingLeft: '40px', paddingRight: '40px', marginTop: '20px' }}>
                                        Designing sustainable development interventions | Design for Success
                                    </p>
                                </Col>
                                <Col style={{ textAlign: 'center', color:'#00ac8d' }}>
                                    <Image src='/img/shape6.png' alt='Health' width={140} height={140} />
                                    <p style={{ paddingLeft: '40px', paddingRight: '40px', marginTop: '20px' }}>
                                        Transforming investment through impact evaluations | Evidence for Change
                                    </p>
                                </Col>
                                <Col style={{ textAlign: 'center', color:'#00ac8d' }}>
                                    <Image src='/img/shape7.png' alt='Health' width={140} height={140} />
                                    <p style={{ paddingLeft: '40px', paddingRight: '40px', marginTop: '20px' }}>
                                        Mobilising partners with number-based and evidence-based action | Monitor for results
                                    </p>
                                </Col>
                                <Col style={{ textAlign: 'center', color:'#00ac8d' }}>
                                    <Image src='/img/shape8.png' alt='Health' width={140} height={140} />
                                    <p style={{ paddingLeft: '40px', paddingRight: '40px', marginTop: '20px' }}>
